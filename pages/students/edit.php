...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($first_name)) {
        ...
        $update_stmt->bind_param(
            ...
            $first_name, $middle_name, $last_name,
            $phone, $date_of_birth, $gender,
            $class_id, $department, $is_active, $student_id
        );
...
$classes_result = $conn->query("SELECT id, class_name, level FROM classes ORDER BY class_name ASC");
$classes = [];
$class_levels = [];
while ($row = $classes_result->fetch_assoc()) {
    $classes[] = $row;
    $class_levels[$row['id']] = $row['level'];
}
?>
                ...
                <form method="POST" action="">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <select id="class_id" name="class_id" class="form-control" onchange="toggleDepartmentField()">
                        ...
                        <!-- Department (shown for SSS) -->
                        <div class="form-group" id="dept_group" style="display:none;">
                            <label for="department">Department <span class="required">*</span></label>
                            <select id="department" name="department" class="form-control">
                                <option value="">Select Department</option>
                                <option value="science" <?php echo ($student['department'] ?? '') === 'science' ? 'selected' : ''; ?>>Science</option>
...
function toggleDepartmentField() {
    ...
    deptGroup.style.display = level.toLowerCase().includes('senior') ? 'block' : 'none';
}
